 ...
 *
 *
 * Note is a GWT-compatible implementation of this
 * class.
 */
object Base64 {
    ...
    private val WEBSAFE_DECODABET = byteArrayOf(-9, -9, -9, -9, -9, -9, -9, -9, -9, // Decimal  0 -  8
            -5, -5, // Whitespace: Tab and Linefeed
            -9, -9, // Decimal 11 - 12
            -5, // Whitespace: Carriage Return
            -9, -9, -9, -9, -9, -9, -9, -9, -9, -9, -9, -9, -9, // Decimal 14 - 26
    ...
    private fun encode3to4(source: ByteArray, srcOffset: Int,
                           numSigBytes: Int, destination: ByteArray, destOffset: Int, alphabet: ByteArray): ByteArray {
        //           1         2         3
     ...
     */
    @JvmOverloads
    fun encode(source: ByteArray, off: Int = 0, len: Int = source.size, alphabet: ByteArray = ALPHABET,
